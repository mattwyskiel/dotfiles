...
```yaml
# SAM Globals
# WARNING: Do not use AllowOrigin: "'*'" in production — wildcard CORS is a security risk (CWE-942).
# Specify your exact domain instead.
Globals:
  Api:
    Cors:
...
aws apigatewayv2 update-api --api-id abc123 \
  --cors-configuration AllowOrigins="https://app.example.com",AllowMethods="GET,POST",AllowHeaders="Content-Type"
```
